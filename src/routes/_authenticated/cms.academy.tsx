...
import { COURSE_CONFIG } from "@/lib/cms/entity-configs";

export const Route = createFileRoute("/_authenticated/cms/academy")({
  component: Page,
});
...
function Page() {
  ...
  return <EntityManager tenantId={tenantId} config={COURSE_CONFIG} />;
}
