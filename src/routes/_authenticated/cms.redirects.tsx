...
import { REDIRECT_CONFIG } from "@/lib/cms/entity-configs";

export const Route = createFileRoute("/_authenticated/cms/redirects")({
  component: Page,
});
...
function Page() {
  ...
  return <EntityManager tenantId={tenantId} config={REDIRECT_CONFIG} />;
}
