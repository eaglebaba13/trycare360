...
import { TREATMENT_CONFIG } from "@/lib/cms/entity-configs";

export const Route = createFileRoute("/_authenticated/cms/treatments")({
  component: Page,
});
...
function Page() {
  ...
  return <EntityManager tenantId={tenantId} config={TREATMENT_CONFIG} />;
}
