...
import { DOCTOR_CONFIG } from "@/lib/cms/entity-configs";

export const Route = createFileRoute("/_authenticated/cms/doctors")({
  component: Page,
});
...
function Page() {
  ...
  return <EntityManager tenantId={tenantId} config={DOCTOR_CONFIG} />;
}
