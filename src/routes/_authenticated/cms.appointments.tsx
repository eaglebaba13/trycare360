...
import { APPOINTMENT_CONFIG } from "@/lib/cms/entity-configs";

export const Route = createFileRoute("/_authenticated/cms/appointments")({
  component: Page,
});
...
function Page() {
  ...
  return <EntityManager tenantId={tenantId} config={APPOINTMENT_CONFIG} />;
}
